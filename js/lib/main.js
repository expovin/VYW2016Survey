//var scriptsUrl = 'http://10.65.6.19/extensions/angularTemplate/';
var scriptsUrl = 'http://192.168.0.106/extensions/angularTemplate/';
/* 
...
*/
require.config({
  baseUrl: "http://192.168.0.106/resources",
  paths: {
